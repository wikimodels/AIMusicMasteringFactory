"""
MP3 Drops Dashboard Backend & Frontend
Запускает локальный веб-сервер с красивым Material Design интерфейсом
для прослушивания и удаления аудионарезок.

Запуск: poetry run python scripts/dashboard.py
"""
